...
/* =====================================================
   ...
   You can add your employees here.
   ...
   If you add employees through the app, they are
   automatically saved in the browser.
===================================================== */
    ...
    const leaveDays =
        state.leaves
            .filter(leave =>
                ...
                monthKey(leave.startDate) === month
...
function outstandingLoan(employee) {
