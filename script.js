...
/* =====================================================
   ...
   - Advances deducted from the selected salary month
     (can be paid in a previous month)
   - Leave editing
...
/* =====================================================
   ADVANCE AGAINST SALARY MONTH
   An advance can be paid in one month and deducted
   from another month's salary.

   Example:
   AED 50 paid in July against August salary
   is deducted from August pending salary.
===================================================== */

function getAdvanceSalaryMonth(
    transaction
) {
...
function getAdvancesForSalaryMonth(
    employee,
    month
) {
...
function payrollFor(
    ...
    */
    ...
    /*
       Advances are deducted from the salary month
       they were assigned to, not from the month
       they were paid.
    */
    ...
    /*
       Remaining salary after salary payments
       AND advances assigned to this month.

       Example:
       August salary due = AED 2,500
       July advance against August = AED 50
       August salary paid = AED 0
       August pending = AED 2,450
    */
        ...
        <div class="form-grid">
            ...
            >
                ...
                <small
                    ...
                    "
                >
                    Choose the salary month this
                    advance should reduce. Example:
                    if AED 50 is given in July
                    against August salary, set the
                    transaction date to July and
                    select August here. August
                    pending salary will then be
                    reduced by AED 50.
                </small>
...
function setupSalaryStartDateBehaviour() {
    ...
    const advanceMonthField =
        $("advanceMonthField");


    const advanceMonthInput =
        $("advanceMonthInput");


    const dateInput =
        document.querySelector(
            '#modalForm input[name="date"]'
        );
    ...
    const update =
        () => {
            ...
            if (advanceMonthField) {

                advanceMonthField.style.display =
                    isAdvance
                        ? ""
                        : "none";
